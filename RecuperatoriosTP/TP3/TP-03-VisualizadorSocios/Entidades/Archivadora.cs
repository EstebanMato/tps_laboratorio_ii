...
namespace Entidades
{
    ...
    public static class Archivadora
    {
        ...
        /// <param name="path">ruta donde guarda</param>
        /// <returns></returns>
        public static bool SerializarJson<T>(T objeto, string path)
        {
        ...
        /// <param name="path">ruta del archivo</param>
        /// <returns></returns>
        public static T DeserializarJson<T>(string path)
        {
            T returnAux = default;
            try
            {
                string jsonString = File.ReadAllText(path);
                returnAux = JsonSerializer.Deserialize<T>(jsonString);
            }
            catch (Exception)
            {
                throw;
